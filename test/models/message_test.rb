...
class MessageTest < ActiveSupport::TestCase
  ...
  test "body_html is filled with rendered html version of body" do
    message = Message.new(body: "Check out https://hirethepivot.com/!")

    assert_equal '<p>Check out <a href="https://hirethepivot.com/" target="_blank">https://hirethepivot.com/</a>!</p>', message.body_html
  end
end
